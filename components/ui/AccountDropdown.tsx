...
const AccountDropdown = ({ user }: UserSession) => {
    ...
    <div>
      ...
      >
        <DropdownTrigger>
          ...
          >
            <Image
              ...
              width={50}
              height={50}
              className="hidden md:block md:size-7 lg:size-10 rounded-full"
              unoptimized={true}
            />
          </div>
        </DropdownTrigger>
        ...
        >
          ...
          <DropdownItem key="settings" className="hover:text-darkblue">Settings</DropdownItem>
