    ...
    <div className="w-[200px] lg:w-[250px] h-[417px] bg-[#434343] relative rounded-lg border-2 border-black/30 md:border-none p-2 flex flex-col gap-2 shadow-[0_4px_4px_rgba(0,0,0,0.25)] card-hover">
      ...
      {features.map((feature, index) => (
        <div className="flex gap-2" key={index}>
          <div className="size-4 rounded-full bg-black mt-1">
      ...
      <div className="absolute bottom-0 mb-2 ml-3 w-[80%]">
        <Button text={buttonText} className={twMerge("w-full lg:text-xl font-medium", buttonClassName)} onClick={handleCheckout}/>
      </div>
      {recommend && (
