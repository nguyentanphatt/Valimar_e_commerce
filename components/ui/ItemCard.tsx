...
export default function ItemCard({
  ...
  return (
    <div
      className={twMerge(
        "flex-none w-[130px] md:w-[200px] lg:w-[250px] h-[150px] md:h-[250px] lg:h-[350px] flex flex-col justify-between bg-white/20 rounded shadow-[0_4px_4px_rgba(0,0,0,0.25)] transform transition-transform duration-200 ease-in-out hover:scale-105 ",
        className
      )}
    >
      <Image
      ...
      />
      <div className="flex px-1 md:px-2 lg:px-3 h-[30px] md:h-[40px] lg:h-[60px]">
        <p className="font-medium text-xs md:text-base lg:text-2xl text-white">
          {name}
        </p>
        {isNew && (
      ...
      <div className="flex px-1 gap-1 md:px-2 lg:px-3">
